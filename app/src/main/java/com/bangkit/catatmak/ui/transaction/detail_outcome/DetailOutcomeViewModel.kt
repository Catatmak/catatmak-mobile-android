...
class DetailOutcomeViewModel(private val repository: CatatmakRepository) : ViewModel() {

    fun getOutcomeCustomDate(startDate: String, endDate: String) =
        repository.getOutcomeCustomDate(startDate, endDate)
